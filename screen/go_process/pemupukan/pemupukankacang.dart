...
class PemupukanKacang extends StatefulWidget {
  @override
  _PemupukanKacangState createState() => _PemupukanKacangState();
}

class _PemupukanKacangState extends State<PemupukanKacang> {
  double opasiti1 = 1;
  double opasiti2 = 1;
  double opasiti3 = 1;
  double opasiti4 = 1;
