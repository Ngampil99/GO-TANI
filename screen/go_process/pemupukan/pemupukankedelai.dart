...
class PemupukanKedelai extends StatefulWidget {
  @override
  _PemupukanKedelaiState createState() => _PemupukanKedelaiState();
}

class _PemupukanKedelaiState extends State<PemupukanKedelai> {
  double opasiti1 = 1;
  double opasiti2 = 1;
  double opasiti3 = 1;
  double opasiti4 = 1;
