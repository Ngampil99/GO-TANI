...
import 'package:go_tani/screen/go_cost/variablecost.dart';
...
class _FixedCostState extends State<FixedCost> {
  ...
  void _savefixedcost(int fixedcost) async {
    SharedPreferences pref = await SharedPreferences.getInstance();
    await pref.setInt('fixedcost', fixedcost);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            title:
                Text("Total Fixed Cost", style: GoogleFonts.getFont('Poppins')),
            foregroundColor: Colors.black,
            centerTitle: true,
